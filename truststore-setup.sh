...
### Cluster key setup.
# Create the cluster keystore for cluster communication.
...
# Import the identity of the cluster'a public key into the trust store so that nodes can identify each other.
